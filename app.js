...
const EGYPT_MESSAGES = [
  { emoji: "💍", text: "يلا يا معلم كمّل… عايز تتجوز ولا لسه بتأجل؟" },
  { emoji: "💵", text: "يسطا خلّص شوية أسئلة وروح تجيب الدولارات!" },
  { emoji: "✈️", text: "كل سؤال بتحله = خطوة ناحية السفر برّه." },
  { emoji: "🌍", text: "كمّل يلا… الشغل الحلو في الخارج مستنيك." },
  { emoji: "🔥", text: "متقعدش كده، حل وخلّص عشان تحقق حلمك." },
  { emoji: "🛫", text: "يسطا OOP دي مش هتسافر لوحدها… انت اللي تسافر!" },
  { emoji: "💒", text: "كمّل كمّل، الجواز مش هيجي وأنت نايم على السرير." },
  { emoji: "💲", text: "حل تاني سؤال واتقرب من راتب بالدولار." },
  { emoji: "🖥️", text: "يلا يا بطل، السيرفر في أمريكا مستنيك." },
  { emoji: "📈", text: "متسيبش الكورس نصه… كمّل علشان الراتب بالدولار." },
  { emoji: "🎫", text: "يسطا كل Class بتفهمه = تذكرة طيارة." },
  { emoji: "💪", text: "كمّل أسئلة وبلاش أعذار النهارده." },
  { emoji: "🌅", text: "النهارده شوية OOP… بكرة سفرة." },
  { emoji: "🏠", text: "يلا حل، عايز شقة ولا لسه إيجار؟" },
  { emoji: "🎮", text: "يسطا الدولار مش هيجي وأنت بتلعب." },
  { emoji: "💶", text: "كمّل… المرتب باليورو مش بالجنيه." },
  { emoji: "🧭", text: "حل حل حل… السفر مش للناس اللي بتوه." },
  { emoji: "🦁", text: "يلا يا وحش، كمّل Chapter وأنت ماشي." },
  { emoji: "🚪", text: "يسطا كل إجابة صح = باب يتفتح برّه." },
  { emoji: "🎯", text: "كمّل آخر حاجة وخلّص… بعدين احلم بالسفر والجواز." }
];
