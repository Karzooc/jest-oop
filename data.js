const assignments = [
  {
    ...
    questions: [
      ...
      { id:20, text:"The minimum number of parameters for a (struct) constructor is _______ parameter(s).", options:["zero","one","two at least","three at least"], correct:1, translate:"العدد الأدنى من المعاملات لـ Constructor الـ struct هو _______ معامل(ات).", explain:"Zero (struct constructor يمكن أن يكون بدون معاملات في C#)." },
